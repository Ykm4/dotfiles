...
created: 2026-08-17
updated: 2026-08-18
notes: ~/.config/claude/_shared/rules/design-system.md から生成（明朝・ゴシック・等幅のシステムスタック、深緑アクセント）
-->
# Style Guide
...
| `accent` | Focal / 1–2 max per diagram | `#2f6f4e` (accent) | `#74bb95` |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(47,111,78,0.08)` | `rgba(116,187,149,0.10)` |
...
Any `rgba(28,43,45, X)` in light becomes `rgba(230,235,228, X)` in dark. Same opacities, RGB flipped. The accent gets a slight hue-shift brighter (`#2f6f4e` → `#74bb95`) to read on dark paper.
